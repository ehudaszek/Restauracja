<?php include 'header/header.php';
	...
	$rezultat = @$polaczenie->query("SELECT nazwa,cena,opis,idDanie FROM restauracja.danie where idKategoria=4;");
echo <<<END
	<article>
		<div class="container">
			<div class="sosyContainer">
				<h4>Duża Średnia Mała</h4>
				<div style="clear:both;"></div>
				<h4>50cm 40cm 30cm</h4>
				<br/>
				<ul class= "meni">
END;
$i=42;
